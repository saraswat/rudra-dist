...
public:
	...
	//-------------------------------------	
	static float	 	   		_alphaDecay;	// rate of decay of learning rate
	...
	//    static Platform             _platform;      // CPU or GPU
	...
	static uint32				  _labelDim;	// number of dimension
